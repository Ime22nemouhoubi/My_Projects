...
#--- automatically generated by goil on Sun Jun 11 23:01:23 2023
...
includeDirs += ["-I","../../../../../..//machines/cortex/armv6m/samd21/XPlainedPro"]
includeDirs += ["-I","../../../../../..//machines/cortex"]
includeDirs += ["-I","../../../../../..//machines/cortex/armv6m"]
includeDirs += ["-I","../../../../../..//machines/cortex/CMSIS/Include"]
includeDirs += ["-I","../../../../../..//machines/cortex/armv6m/samd21/CMSIS-Atmel/Device/ATMEL"]
includeDirs += ["-I","../../../../../..//machines/cortex/armv6m/samd21"]
includeDirs += ["-I","../../../../../..//machines/cortex/armv6m/samd21/utils"]
if with_ioc:
  includeDirs += ["-I", "../../../../../..//ioc"]
includeDirs += ["-I", "../../../../../..//os"]
includeDirs += ["-I", "../../../../../..//debug"]
...
postVariableMapping = dict(
  ...
  BOARD_PATH='../../../../../..//machines/cortex/armv6m/samd21/XPlainedPro',
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("openocd") != None:
      print("\033[1m\033[95mFlashing pfeMouhoubi_exe on cortex/armv6m/samd21/XPlainedPro\033[0m")
