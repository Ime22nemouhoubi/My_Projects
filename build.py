...
#--- automatically generated by goil on Tue May  2 13:46:56 2023
...
cflags += "-I../board/iutNantes/include".split()
cflags += "-O3 -std=c99".split()
...
cflags += "-D__SAMD21J18A__".split()
cppflags += "-D__SAMD21J18A__".split()
cflags += "-g".split()
cppflags += "-g".split()
cflags += "-Wall".split()
cppflags += "-Wall".split()
...
includeDirs += ["-I","/usr/share/trampoline-master//machines/cortex/armv6m/samd21/XPlainedPro"]
includeDirs += ["-I","/usr/share/trampoline-master//machines/cortex"]
includeDirs += ["-I","/usr/share/trampoline-master//machines/cortex/armv6m"]
includeDirs += ["-I","/usr/share/trampoline-master//machines/cortex/CMSIS/Include"]
includeDirs += ["-I","/usr/share/trampoline-master//machines/cortex/armv6m/samd21/CMSIS-Atmel/Device/ATMEL"]
includeDirs += ["-I","/usr/share/trampoline-master//machines/cortex/armv6m/samd21"]
includeDirs += ["-I","/usr/share/trampoline-master//machines/cortex/armv6m/samd21/utils"]
if with_ioc:
  includeDirs += ["-I", "/usr/share/trampoline-master//ioc"]
includeDirs += ["-I", "/usr/share/trampoline-master//os"]
includeDirs += ["-I", "/usr/share/trampoline-master//debug"]
includeDirs += ["-I", "pfeMouhoubi"]
cflags   += includeDirs
...
#--- OIL file
oilSourceList.append("pfeMouhoubi.oil")
...
cSourceList.append(projfile.ProjectFile("../board/iutNantes/src/adc.c"))
cSourceList.append(projfile.ProjectFile("../board/iutNantes/src/oled.c"))
cSourceList.append(projfile.ProjectFile("../board/iutNantes/src/serial.c"))
cSourceList.append(projfile.ProjectFile("../board/iutNantes/src/dac.c"))
cSourceList.append(projfile.ProjectFile("../board/iutNantes/src/redirectPrintf.c"))
cSourceList.append(projfile.ProjectFile("../board/iutNantes/src/timer.c"))
cSourceList.append(projfile.ProjectFile("pfeMouhoubi.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("pfeMouhoubi/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("pfeMouhoubi/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("pfeMouhoubi/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("pfeMouhoubi/tpl_primary_irq.S"))
cSourceList.append(projfile.ProjectFile("pfeMouhoubi/tpl_vectors.c"))
cSourceList.append(projfile.ProjectFile("pfeMouhoubi/tpl_external_interrupts.c"))
cSourceList.append(projfile.ProjectFile("pfeMouhoubi/tpl_app_interrupts.c"))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv6m/samd21/XPlainedPro/system_samd21_XPlainedPro_48MHz.c", trampoline_base_path))
...
cSourceList.append(projfile.ProjectFile("machines/cortex/armv6m/sys_handlers.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv6m/tpl_ctx_switch.S", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv6m/tpl_ctx_switch_under_it.S", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv6m/tpl_interrupts.S", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv6m/samd21/tpl_machine_samd.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv6m/samd21/startup_samd.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv6m/samd21/utils/pinAccess.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv6m/samd21/utils/pinMux.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv6m/samd21/utils/eic.c", trampoline_base_path))
#----------------------------------------------------------------------
...
postVariableMapping = dict(
  MACHINE_PATH='/usr/share/trampoline-master//machines',
  ARCH_PATH='/usr/share/trampoline-master//machines/cortex',
  BOARD_PATH='/usr/share/trampoline-master//machines/cortex/armv6m/samd21/XPlainedPro',
  TARGET='cortex/armv6m/samd21/XPlainedPro'
)
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    commandLine = "openocd -f board/atmel_samd21_xplained_pro.cfg -c \"program "
    commandLine += "pfeMouhoubi.elf "
    commandLine += " verify reset exit\" "
    commandLineTemplate = Template(commandLine)
    commandLine = commandLineTemplate.safe_substitute(postVariableMapping)
    if makefile.find_executable("openocd") != None:
      print("\033[1m\033[95mFlashing pfeMouhoubi.elf on cortex/armv6m/samd21/XPlainedPro\033[0m")
      subprocess.call(commandLine, shell=True)
    else:
      print("Command 'openocd' not in PATH")
